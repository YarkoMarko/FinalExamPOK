...
module top ;
	...
	wire [0:0] tmpOE__DS_Pin_net;
	wire [0:0] tmpFB_0__DS_Pin_net;
	wire [0:0] tmpIO_0__DS_Pin_net;
	wire [0:0] tmpINTERRUPT_0__DS_Pin_net;
	electrical [0:0] tmpSIOVREF__DS_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		DS_Pin
		 (.oe(tmpOE__DS_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DS_Pin_net[0:0]}),
		  .io({tmpIO_0__DS_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__DS_Pin_net),
		  .interrupt({tmpINTERRUPT_0__DS_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DS_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SHCP_Pin_net;
	wire [0:0] tmpFB_0__SHCP_Pin_net;
	wire [0:0] tmpIO_0__SHCP_Pin_net;
	wire [0:0] tmpINTERRUPT_0__SHCP_Pin_net;
	electrical [0:0] tmpSIOVREF__SHCP_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("91917898-7fe1-45db-a495-544c664b2c48"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SHCP_Pin
		 (.oe(tmpOE__SHCP_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SHCP_Pin_net[0:0]}),
		  .io({tmpIO_0__SHCP_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__SHCP_Pin_net),
		  .interrupt({tmpINTERRUPT_0__SHCP_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SHCP_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__STCP_Pin_net;
	wire [0:0] tmpFB_0__STCP_Pin_net;
	wire [0:0] tmpIO_0__STCP_Pin_net;
	wire [0:0] tmpINTERRUPT_0__STCP_Pin_net;
	electrical [0:0] tmpSIOVREF__STCP_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("f38cf4f3-212a-4325-a82c-169595b6f4fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		STCP_Pin
		 (.oe(tmpOE__STCP_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__STCP_Pin_net[0:0]}),
		  .io({tmpIO_0__STCP_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__STCP_Pin_net),
		  .interrupt({tmpINTERRUPT_0__STCP_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__STCP_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MR_Pin_net;
	wire [0:0] tmpFB_0__MR_Pin_net;
	wire [0:0] tmpIO_0__MR_Pin_net;
	wire [0:0] tmpINTERRUPT_0__MR_Pin_net;
	electrical [0:0] tmpSIOVREF__MR_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("54498443-8f8d-448c-8565-8dc66ffe9b74"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MR_Pin
		 (.oe(tmpOE__MR_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MR_Pin_net[0:0]}),
		  .io({tmpIO_0__MR_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__MR_Pin_net),
		  .interrupt({tmpINTERRUPT_0__MR_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MR_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OE_Pin_net;
	wire [0:0] tmpFB_0__OE_Pin_net;
	wire [0:0] tmpIO_0__OE_Pin_net;
	wire [0:0] tmpINTERRUPT_0__OE_Pin_net;
	electrical [0:0] tmpSIOVREF__OE_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("ccf403f9-0297-4ddf-9b9e-9a788ee056bf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OE_Pin
		 (.oe(tmpOE__OE_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OE_Pin_net[0:0]}),
		  .io({tmpIO_0__OE_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__OE_Pin_net),
		  .interrupt({tmpINTERRUPT_0__OE_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OE_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Q0_Pin_net;
	wire [0:0] tmpIO_0__Q0_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Q0_Pin_net;
	electrical [0:0] tmpSIOVREF__Q0_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("7a09bfe0-b35a-45f0-b2b5-83772b766012"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Q0_Pin
		 (.oe(tmpOE__Q0_Pin_net),
		  .y({1'b0}),
		  .fb({Net_28}),
		  .io({tmpIO_0__Q0_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Q0_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Q0_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Q0_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Q1_Pin_net;
	wire [0:0] tmpIO_0__Q1_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Q1_Pin_net;
	electrical [0:0] tmpSIOVREF__Q1_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("14025776-f3f3-483b-bd30-c1c481e074ef"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Q1_Pin
		 (.oe(tmpOE__Q1_Pin_net),
		  .y({1'b0}),
		  .fb({Net_29}),
		  .io({tmpIO_0__Q1_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Q1_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Q1_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Q1_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Q2_Pin_net;
	wire [0:0] tmpIO_0__Q2_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Q2_Pin_net;
	electrical [0:0] tmpSIOVREF__Q2_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("273c7da0-60db-414b-b18a-6f2ded731394"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Q2_Pin
		 (.oe(tmpOE__Q2_Pin_net),
		  .y({1'b0}),
		  .fb({Net_30}),
		  .io({tmpIO_0__Q2_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Q2_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Q2_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Q2_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Q3_Pin_net;
	wire [0:0] tmpIO_0__Q3_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Q3_Pin_net;
	electrical [0:0] tmpSIOVREF__Q3_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("166b8d39-d4cc-4a85-9bf0-840ccb14e37f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Q3_Pin
		 (.oe(tmpOE__Q3_Pin_net),
		  .y({1'b0}),
		  .fb({Net_31}),
		  .io({tmpIO_0__Q3_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Q3_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Q3_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Q3_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Q4_Pin_net;
	wire [0:0] tmpIO_0__Q4_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Q4_Pin_net;
	electrical [0:0] tmpSIOVREF__Q4_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("cba92b81-b911-469e-90a6-da0c190a64e4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Q4_Pin
		 (.oe(tmpOE__Q4_Pin_net),
		  .y({1'b0}),
		  .fb({Net_32}),
		  .io({tmpIO_0__Q4_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Q4_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Q4_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Q4_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Q5_Pin_net;
	wire [0:0] tmpIO_0__Q5_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Q5_Pin_net;
	electrical [0:0] tmpSIOVREF__Q5_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("5a49d2d1-9fc4-46de-90b8-f62e997c5524"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Q5_Pin
		 (.oe(tmpOE__Q5_Pin_net),
		  .y({1'b0}),
		  .fb({Net_33}),
		  .io({tmpIO_0__Q5_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Q5_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Q5_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Q5_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Q6_Pin_net;
	wire [0:0] tmpIO_0__Q6_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Q6_Pin_net;
	electrical [0:0] tmpSIOVREF__Q6_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("88c23ee9-0256-4d29-86ba-1d15284a782c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Q6_Pin
		 (.oe(tmpOE__Q6_Pin_net),
		  .y({1'b0}),
		  .fb({Net_34}),
		  .io({tmpIO_0__Q6_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Q6_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Q6_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Q6_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Q7_Pin_net;
	wire [0:0] tmpIO_0__Q7_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Q7_Pin_net;
	electrical [0:0] tmpSIOVREF__Q7_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("f2224dd2-18bf-4949-ba6b-2ef5452ccd23"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Q7_Pin
		 (.oe(tmpOE__Q7_Pin_net),
		  .y({1'b0}),
		  .fb({Net_35}),
		  .io({tmpIO_0__Q7_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Q7_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Q7_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Q7_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("856405f7-7866-4786-8c28-669fcae52b39"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("039f1fbb-653c-4736-a916-d904248252c5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
