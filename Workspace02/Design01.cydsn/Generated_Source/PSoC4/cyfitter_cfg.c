...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL0, 0x00002A00u);
	...
	CyIntEnable(8u);
	CY_SET_REG32((void *)(CYREG_WDT_CONFIG), 0x40000000u);
	/* Set Flash Cycles based on newly configured 5.00MHz HFCLK. */
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00DB13B6u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC2), 0x00000020u);

	/* IOPINS0_2 Starting address: CYDEV_GPIO_PRT2_BASE */
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC), 0x00189249u);

	/* IOPINS0_3 Starting address: CYDEV_GPIO_PRT3_BASE */
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x00180001u);
